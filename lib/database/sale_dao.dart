...
class SaleDao {
  ...
  Future<int> insertSale(Sale sale, List<SaleItem> items, List<Installment> installments) async {
    ...
    await db.transaction((txn) async {
      ...
      for (final inst in installments) {
        final instMap = inst.toMap()..remove('id');
        await txn.insert('installments', instMap);
      }
    });
    return saleId;
  }
